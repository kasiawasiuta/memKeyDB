This is README for MemKeyDB - Redis mirror, adjusted to store objects on both DRAM and Intel Optane Persistent Memory.
...
The data stored on the medium is volatile and the persistency is preserved with AOF mechanism.
